...
public class IconTextTabFragment extends DialogFragment {
    private PagerSlidingTabStrip tabs;
    private ViewPager pager;
    private ContactPagerAdapter adapter;
    public static IconTextTabFragment newInstance() {
        IconTextTabFragment f = new IconTextTabFragment();
        return f;
    }
    @Override
    ...
    public class ContactPagerAdapter extends PagerAdapter implements PagerSlidingTabStrip.IconTitleProvider {
        ...
        private final String[] TITLE = {"Google+", "GMial", "Google Maps", "Chrome"};
        @Override
